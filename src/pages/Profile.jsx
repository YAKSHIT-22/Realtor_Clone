     ...
     <section className="max-w-6xl mx-auto flex justify-center items-center flex-col">
      ...
      <div className="w-full md:w-1/2 flex flex-col items-center justify-center mt-6 px-2 gap-4">
        <form className="w-full flex flex-col items-center justify-center mt-6 px-2 gap-4">
          <input type="text" id="name" value={name} disabled={!changeDetail} onChange={onChange} className={"w-full px-4 py-2 text-xl text-gray-700 rounded transition ease-in-out" + (changeDetail ? "bg-red-200 focus:bg-red-200" : " bg-white border border-gray-300") }/>
          ...
          <div className="w-full flex items-center justify-between flex-row whitespace-nowrap text-sm">
            <p className="flex items-center justify-center flex-row gap-1">Want to change your name?
              ...
              }} className="text-red-600 hover:text-red-700 transition ease-in-out duration-150 ml-1 cursor-pointer">{changeDetail ? "Apply Change":"Edit"}</span>
            </p>
